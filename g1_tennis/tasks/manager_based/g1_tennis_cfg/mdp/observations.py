...
def racket_pos_rel_base(env: ManagerBasedEnv) -> torch.Tensor:
    ...
    racket_pos_b = math_utils.quat_rotate_inverse(base_quat, racket_pos - base_pos)
    return racket_pos_b
...
def racket_vel_rel_base(env: ManagerBasedEnv) -> torch.Tensor:
    ...
    racket_vel_b = math_utils.quat_rotate_inverse(base_quat, racket_vel_w)
    return racket_vel_b
...
def racket_facing_rel_base(env: ManagerBasedEnv) -> torch.Tensor:
    ...
    racket_facing_b = math_utils.quat_rotate_inverse(
        robot_base_quat_w, 
